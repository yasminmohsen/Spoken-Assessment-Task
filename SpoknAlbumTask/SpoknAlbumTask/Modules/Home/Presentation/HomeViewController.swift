...
class HomeViewController: UIViewController {
    ...
    private func setupActionObserves(){
        ...
        albumTableView
            ...
            .subscribe(onNext: { [weak self] albm in
                        guard let self = self else {return}
                        if let albumImgVC = self.storyboard?.instantiateViewController(identifier: "AlbumImgVC")as?AlbumImageViewController { // set Properties to AlbumImageViewController
